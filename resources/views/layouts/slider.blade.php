        ...
        <div class="tp-banner" >
            ...
            @foreach($slider as $slide)
                ...
                <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700" >
                    <!-- MAIN IMAGE -->
                    <img src="images/slider/{{$slide->img}}" alt="slidebg1" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                    <!-- LAYERS -->
                    <!-- LAYER NR. 1 -->
                    <div class="tp-caption very_big_white skewfromrightshort fadeout"
                         ...
                         style=" font-size:70px; font-weight:800; color:#fe0100;">{{$slide->title}} <span style=" color:#000;">{{$slide->title1}}</span> </div>
                    ...
                    <div class="tp-caption tp-caption medium_text skewfromrightshort fadeout"
                         ...
                         style=" font-size:20px; font-weight:500; color:#337ab7;"> {{$slide->desc}} </div>
                ...
                <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700" >
                    ...
                    <div class="tp-caption white_heavy_60 customin ltl tp-resizeme"
                         ...
                         style=" font-size:70px; font-weight:800; color:#333;">{{$slide->title}} </div>
                    ...
                    <div class="tp-caption black_thin_blackbg_30 customin ltl tp-resizeme"
                         ...
                         data-endspeed="1000"
                         data-endeasing="Power4.easeIn"
                         style="z-index: 3; max-width: auto; max-height: auto; white-space: nowrap; color:#34bcec; font-size:20px; font-weight:500;">{{$slide->desc}} </div>
                ...
                <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700" >
                    <!-- MAIN IMAGE -->
                    <img src="images/slider/{{$slide->img}}" alt="slidebg3" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                    <!-- LAYERS -->
                    <!-- LAYER NR. 1 -->
                    <div class="tp-caption big_100_white lft start fadeout"
                         ...
                         data-start="1200"
                         data-easing="Circ.easeInOut"
                         style=" font-size:70px; font-weight:800; color:#fff;">{{$slide->title}}</div>
                    <div class="tp-caption big_100_white lft fadeout"
                         ...
                         data-start="1200"
                         data-easing="Circ.easeInOut"
                         style=" font-size:50px; font-weight:800; color:#fed700;">{{$slide->title1}}</div>
